...
(454626, 1, 'Buenisima, espero que les guste cómo a mi.', '2018-08-15','2020-06-24', 9 ),
...
(495764, 2, 'Te entretiene pero no es de las mejores que vi.', '2001-05-24','2010-06-20', 7 ),

(508439, 2, ' Me gusto bastante ya que es muy real.', '1999-07-29', , 6.8 ),

(530915, 2, 'Malisima, muy larga y densa. ', '2010-09-04', , 2 ),

(652, 2, ' Dentro de todo está buena, hay mejores pero esta se defiende.', '2011-12-11','2019-07-27', 4.5 ),
...
(698320, 3, 'Excelente pelicula para ver un dia de lluvia y con tus hermanos. La película te deja una enseñanza de vida familiar. ', '2010-09-15','2018-07-14', 10 ),
...
que se le hace a los Avengers originales es nostálgico y, sin duda emocionante.', '2019-04-27','2019-05-05', 9.2 ),

(299534, 5, 'Después de ver esta película, puedo decir que, Tom Holland es el
mejor Spiderman hasta la fecha.', '2019-11-07', , 8.9 ),

(320288, 5, 'Lamentablemente los X-Men se van de Fox en una nota muy baja.', ' 2019-10-19','2019-11-19', 5 );